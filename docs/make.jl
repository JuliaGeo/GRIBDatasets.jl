...
makedocs(;
    ...
    repo="https://github.com/JuliaGeo/GRIBDatasets.jl/blob/{commit}{path}#{line}",
    sitename="GRIBDatasets.jl",
    format=Documenter.HTML(;
        prettyurls=get(ENV, "CI", "false") == "true",
        canonical="https://JuliaGeo.github.io/GRIBDatasets.jl",
        edit_link="main",
        assets=String[],
    ),
    pages=[
...
deploydocs(;
    repo="github.com/JuliaGeo/GRIBDatasets.jl",
    devbranch="main",
)
